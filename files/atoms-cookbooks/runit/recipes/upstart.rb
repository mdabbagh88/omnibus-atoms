...
cookbook_file "/etc/init/atoms-runsvdir.conf" do
  owner "root"
  group "root"
  mode "0644"
  source "atoms-runsvdir.conf"
end
...
execute "initctl status atoms-runsvdir" do
  retries 30
end
...
execute "initctl start atoms-runsvdir" do
  only_if "initctl status atoms-runsvdir | grep stop"
  retries 30
end
